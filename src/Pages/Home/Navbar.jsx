    ...
    return (
        <nav className={`navbar ${navActive ? "active" : ""}`}>
            ...
            <div className={`navbar-items ${navActive ? "active" : ""}`}>
                <ul>
                    <li>
                        <Link onClick={closeMenu} activeClass="navbar-active-content" spy={true} smooth={true} offset={-70} duration={500} to="introSection" className="navbar-content">Home</Link>
                    </li>
                    <li>
